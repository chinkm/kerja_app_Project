...
function App() {
    ...
    return (
        <div className="bg-white text-dark vw-100 min-vh-100 overflow-x-hidden pb-5">

            {/* Top Blue Header Section */}
            <div className="rounded-bottom px-4 pt-4 pb-4" style={{ backgroundColor: '#5C85D6' }}>
                {/* Tailwind-Native Header Row */}
<div className="flex flex-nowrap items-center justify-between w-full gap-3">
    ...
    <div className="flex items-center gap-2 min-w-0 overflow-hidden">
        ...
        {/* Text Container - min-w-0 is the Tailwind secret to fixing flex-truncation! */}
        <div className="text-white min-w-0">
            <p className="text-xs opacity-75">Your Location</p>  
            <div className="flex items-center gap-1 cursor-pointer">
                <div className="font-bold text-lg truncate">Gamuda Ai Academy</div>
    ...
    <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-white/20 bg-gray-100 flex-shrink-0">
        <img src="https://i.pravatar.cc/150?img=11" alt="Profile" className="w-full h-full object-cover" />
                ...
                {activeModule === 'voiceProfile' && (
                    <div className="position-relative bg-white mt-4">
                        <div className="d-flex justify-content-end mb-2 mx-auto" style={{ maxWidth: '42rem' }}>
                            <button onClick={() => setActiveModule(null)} className="btn btn-outline-danger btn-sm fw-bold">✕ Close Module Window</button>
                        </div>
                        <VoiceProfileModule />
                    </div>
                )}
            ...
            <div className="mt-2 pb-5 mb-5">
                <h2 className="fw-bolder fs-4 mb-3 px-4" style={{ color: '#4E80E6', letterSpacing: '-0.02em' }}>Recommended for you</h2>
                <div className="d-flex flex-nowrap overflow-auto px-4 gap-3 pb-3" style={{ scrollSnapType: 'x mandatory', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                    <style>{`.overflow-auto::-webkit-scrollbar { display: none; }`}</style>
                    {[1, 2, 3, 4, 5].map((item) => (
                        <div key={item} className="card border-0 shadow-sm rounded-4 overflow-hidden flex-shrink-0" style={{ backgroundColor: '#ffffff', width: '85vw', maxWidth: '340px', scrollSnapAlign: 'center' }}>
                            <div className="d-flex flex-row align-items-stretch h-100">
                                <div className="flex-shrink-0" style={{ width: '35%', minHeight: '135px' }}>
                                    <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=300&auto=format&fit=crop" className="w-100 h-100" style={{ objectFit: 'cover' }} alt="Home Cleaning" />
                                </div>
                                <div className="p-3 d-flex flex-column justify-content-center flex-grow-1 overflow-hidden" style={{ width: '65%' }}>
                                    ...
                                    <p className="text-secondary mb-1 text-truncate w-100" style={{ fontSize: '0.8rem' }}>Ad &bull; 2.2km (5min above)</p>
                                    ...
                                    <div className="d-flex align-items-center mt-auto w-100">
                                        ...
                                        <div className="overflow-hidden w-100">
                                            <div className="d-flex align-items-center gap-1"><span className="fw-bolder text-dark text-truncate" style={{ fontSize: '0.95rem' }}>Kunafa</span><svg width="14" height="14" viewBox="0 0 24 24" fill="#00C2FF" className="flex-shrink-0"><circle cx="12" cy="12" r="10" /></svg></div>
                                            <div className="d-flex align-items-center text-secondary" style={{ fontSize: '0.8rem' }}><span className="text-warning me-1 fs-6">★</span><span className="text-truncate">4.3 (277 reviews)</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="fixed-bottom bg-white shadow border-top pt-2 pb-3" style={{ zIndex: 1050 }}>
                <div className="d-flex justify-content-around align-items-center px-2">
                    <div className="text-center d-flex flex-column align-items-center" style={{ cursor: 'pointer', color: '#7A848F' }}><svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline strokeLinecap="round" strokeLinejoin="round" points="9 22 9 12 15 12 15 22"></polyline></svg><span className="mt-1 fw-bold" style={{ fontSize: '11px' }}>Home</span></div>
                    <div className="text-center d-flex flex-column align-items-center" style={{ cursor: 'pointer', color: '#7A848F' }}><svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg><span className="mt-1 fw-bold" style={{ fontSize: '11px' }}>Activity</span></div>
                    <div className="text-center d-flex flex-column align-items-center position-relative" style={{ cursor: 'pointer', color: '#7A848F' }}><div className="position-relative"><svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg><span className="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-danger border border-white border-2" style={{ padding: '3px 5px', fontSize: '9px', transform: 'translate(-30%, -30%)' }}>1</span></div><span className="mt-1 fw-bold" style={{ fontSize: '11px' }}>Messages</span></div>
                    <div className="text-center d-flex flex-column align-items-center" style={{ cursor: 'pointer', color: '#4E80E6' }}><svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg><span className="mt-1 fw-bold" style={{ fontSize: '11px' }}>Profile</span></div>
                </div>
            </div>
        </div>
    );
